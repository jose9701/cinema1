...
<%    DatosReservas oDatosReservas = new DatosReservas();
    ...
    Enumeration eLista1 = oListaReservas.elements();
%>
        ...
        <div class="maincontentinner">
            <div class="content1">
                ...
                <div class="content" style="height: 400px; overflow: auto">
                    ...
                    <div >
                    <h2 id="default" class="form"><span>ELIMINAR RESERVA </span></h2>    
                        <form id="eliminarReserva" method="post" action="EliminarReserva.jsp" >

                            <select name="select">
                                <option value="">seleccione una reserva</option>
                                <% 
                                    while (eLista1.hasMoreElements()) {
                                        Reserva aux = (Reserva) eLista1.nextElement();
                                %> 
                                <option value="<%=aux.getIdReserva()%>"> <%=aux.getIdReserva()%></option>
