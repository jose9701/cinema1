...
// JavaScript Document
jQuery.fn.function_wizard=function(){
...
$('body').append('<div id="popup1" style="display: block; height: 100%; left: 50%; position: fixed; top: 50px; width: 100%;z-index: 10001;"></div>');
}
var url = $(this).attr('href');
$('body').css("position","relative");
$('#popup1').hide().load(url).fadeIn(800);
e.preventDefault();
...
if (((idclick!=idpopup) && !($.contains(padre,Node))))/*compruebo si donde hizo click y si el nodo es hijo*/
{
$('#fancy1').remove();
$('#popup1').remove();
$('#'+idpopup).remove();
